...
namespace AuthServer.Service.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public AuthenticationService(IOptions<List<Client>> optionsClient, ITokenService tokenService,
            UserManager<UserApp> userManager, IUnitOfWork unitOfWork , IGenericRepository<UserRefreshToken> userRefreshToken)
        {
        ...
        public async Task<Response<TokenDto>> CreateTokenByRefreshToken(string refreshToken)
        {
            ...
            if(user==null) return Response<TokenDto>.Fail("Refresh token not found", 404, true);
